...
class DjangoCourse extends StatefulWidget {
  const DjangoCourse({super.key});

  @override
  State<DjangoCourse> createState() => _DjangoCourseState();
}

class _DjangoCourseState extends State<DjangoCourse> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Django Framework"),
        centerTitle: true,
