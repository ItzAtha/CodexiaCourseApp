                    ...
                    children: <Widget>[
                      Row(
                        children: <Widget>[
                          ...
                          SizedBox(width: 10.0),
                          Expanded(child: Divider(thickness: 1.2, height: 20.0, color: Colors.black,)),
                        ],
                      ),
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      SizedBox(height: 10.0),
                      Text("Version 1.0.0", style: TextStyle(fontSize: 14.0, color: Colors.grey.shade600), textAlign: TextAlign.center),
                    ],
                  ),
                ),
              ),
